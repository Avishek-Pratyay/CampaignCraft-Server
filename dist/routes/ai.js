...
router.post('/generate-copy', auth_1.authMiddleware, async (req, res) => {
...
router.post('/recommendations', auth_1.authMiddleware, async (req, res) => {
...
- CPC: $${campaign.cpc}
- CTR: ${campaign.ctr}%
${brand ? `- Brand Industry: ${brand.industry}\n- Brand Target Audience: ${brand.targetAudience}` : ''}
...
function generateMockDataAnalysis(stats, rows) {
